...
if choice == "🏠 Home":
    st.title("📄 DocIQ App")
    st.markdown("""
    Welcome to **DocIQ App**! 🚀

    **Built using Open Source Stack (Llama 3.2, BGE Embeddings, and Qdrant running in local mode.)**
    ...
    Enhance your document management experience with DocIQ! 😊
    """)
...
# Contact Page
    ...
    - **Email:** [developer@example.com](mailto:arthirajendran24@gmail.com) ✉️
    - **GitHub:** [Contribute on GitHub](https://github.com/arthi-rajendran24/DocIQ.git)
...
# Footer
st.markdown("---")
st.markdown("© 2024 DocIQ by Arthi & AI. All rights reserved. 🛡️")